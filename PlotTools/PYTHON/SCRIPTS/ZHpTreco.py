...
## Setup Axes
ZH.GetXaxis().SetRangeUser(20, 280)
ZH.SetMaximum(1.23)
ZH.SetMinimum(0.97)
ZH.GetXaxis().SetTitle('p_{T}^{Reco}')
ZH.GetXaxis().SetTitleOffset(0.95)
ZH.GetXaxis().SetTitleSize(0.040)
ZH.GetXaxis().SetLabelSize(0.040)

ZH.GetYaxis().SetTitle('<p_{T}^{Reco}/p_{T}^{Truth}>')
ZH.GetYaxis().SetTitleOffset(1.05)
ZH.GetYaxis().SetTitleSize(0.040)
ZH.GetYaxis().SetLabelSize(0.040)
...
c.Print('Plots/Profile/prof_cw_ZH.pdf')
